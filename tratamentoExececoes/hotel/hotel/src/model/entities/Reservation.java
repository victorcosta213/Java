...
public class Reservation {
    ...
    public Reservation(int roomNumber, Date checkin, Date checkout) throws DomianException {
    ...
    public void updateDates (Date checkin, Date checkout) throws DomianException{
        ...
        if (checkin.before(now)||checkout.before(now)){
            throw  new DomianException("Error in reservation: Reservation dates for update must be future dates");
        }
        if (!checkout.after(checkin)){
            throw new DomianException("Error in reservation: Check-out date must be after check-in date");
        }
